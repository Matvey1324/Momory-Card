...
q1 = Question('Яка правильна назва гри', 'Dota 2', 'Дота 2', 'DOTA2', 'dota')
q2 = Question('Столиця США', 'Вашингтон', 'Нью-Йорк', 'Лос-Анджелес', 'Кривой Рог')
q3 = Question('Самий сухий материк', 'Австралія', 'Африка', 'Евразія', 'Антарктида')
q4 = Question('Якя тварина живе на Антрактиді', 'Пінгвін', 'Вовк', 'Кенгуру', 'Капібара')
